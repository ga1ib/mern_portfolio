...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-b from-[#0B0B2E] to-[#1a1a4a] text-white px-6">
            ...
            <div className="mt-10">
              ...
              <div className="flex space-x-4">
                <a
                  ...
                  className="bg-gray-700 hover:bg-indigo-600 h-10 w-10 rounded-full flex items-center justify-center transition-colors duration-300"
                >
